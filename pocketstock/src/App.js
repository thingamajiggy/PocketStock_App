  ...
  return (
    ...
    <div>
      ...
      <Routes>
        ...
        <Route path="/Inventory" element={<Inventory setPatching={setPatching}/>} />
        <Route path="/Myproducts" element={<MyProducts />} />
        <Route path="/Orders" element={<Orders setSubmitting={setSubmitting} orders={orders} setOrders={setOrders}/>} />
